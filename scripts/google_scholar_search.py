...
class Search:
    ...
    def search(self, mode):
        ...
        #print(search_term[1:])
        #search_term = "https://scholar.google.com/scholar?hl=en&as_sdt=0%2C5&q="+self.search_terms_exact+"t&btnG="
        #"https://scholar.google.com/scholar?hl=en&scisbd=1&as_sdt=0%2C5&q=allintitle%3A+interaction+OR+cooperation+OR+collaboration+%22human+robot%22+&btnG="
        #search_term = "https://scholar.google.com/scholar?as_q=&as_epq="+self.search_terms_exact+"&as_oq="+self.search_terms_at_least_one+"&as_eq=&as_occt=any&as_sauthors=&as_publication=&as_ylo="+self.search_year+"&as_yhi="+self.search_year+"&hl=en&as_sdt=0%2C5"
